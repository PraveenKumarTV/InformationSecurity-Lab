...
public class Alice{
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            String akey=publicKey.x+","+publicKey.y;
            byte[] res=akey.getBytes();
            ...
            String bkey=new String(reqPkt.getData(),0,reqPkt.getLength());
            System.out.println(bkey);
            String[] coords=bkey.split(",");
            int x=Integer.parseInt(coords[0]);
            int y=Integer.parseInt(coords[1]);
            Point bplc=new Point(x,y);
        } catch (Exception e) {
        }
    }
}
